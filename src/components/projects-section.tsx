...
const ProjectCard = ({ project, index }: { project: Project, index: number }) => {
  return (
    <Card key={project.id} className="flex flex-col overflow-hidden transform transition-transform duration-300 ease-in-out shadow-lg hover:shadow-primary/10 border-accent/50 animate-fade-in bg-black/40 backdrop-blur-xl rounded-2xl" style={{ animationDelay: `${index * 100}ms`}}>
