...
const ProjectCard = ({
  ...
  return (
    <Card
      ref={cardRef}
      key={project.id}
      className="group flex flex-col overflow-hidden transform transition-transform duration-300 ease-in-out shadow-lg hover:shadow-primary/10 animate-fade-in bg-[#080808]/90 backdrop-blur-md rounded-2xl relative border border-white/10"
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {project.tags.map((tag) => (
              <Badge
                key={tag}
                variant={
                  tag === "Work In Progress" ? "destructive" : "secondary"
                }
            ...
            {activeTab === "personal" ? (
              <>
                ...
                <p className="text-lg text-muted-foreground">
                  Here’s what happens when I have too much screen time. I build
                  stuff. Some of it even works. Take a look!
                </p>
              </>
            ) : (
              <>
                ...
                <p className="text-lg text-muted-foreground">
                  I&apos;ve had the pleasure of collaborating with some amazing
                  companies. Here&apos;s a glimpse of our work.
                </p>
              </>
            )}
          </div>
            ...
            {personalProjects.length === 0 && (
              <div className="text-center col-span-full py-12">
                <p className="text-muted-foreground">
                  No personal projects to show yet.
                </p>
              </div>
            )}
          </TabsContent>
